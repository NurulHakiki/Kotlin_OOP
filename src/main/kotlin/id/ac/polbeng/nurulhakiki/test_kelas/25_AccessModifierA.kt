...
sebuah objek, akan tetapi ia bisa diwariskan ke kelas yang lainnya.
Sebuah kelas abstrak biasanya berisi anggota abstrak (abstract member)
yang tidak memiliki implementasi dan harus di override didalam
subclassnya. Anggota abstrak memiliki akses modifier open secara
default, jadi kita tidak perlu menulisnya secara eksplisit ketika mau
di override
 */